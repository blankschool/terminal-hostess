...
export function SettingsPanel({ isDark, onClose }: SettingsPanelProps) {
  return (
    <motion.div 
    ...
    >
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <select className={`w-full px-4 py-2 ${isDark ? 'bg-[#0f0f0f] border-[#2a2a2a] text-white' : 'bg-[#f5f5f5] border-[#d0d0d0] text-[#1a1a1a]'} border rounded-lg focus:outline-none ${isDark ? 'focus:border-[#4a4a4a]' : 'focus:border-[#999999]'}`}>
